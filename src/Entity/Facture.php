 ...
 * @ORM\Index(name="IDX_EB71D8F519EB6921", columns={"acompte_id"})}),
 *  * @ORM\Index(name="IDX_EB71D8F519EB6921", columns={"iban_id"})})
...
class Facture extends \SSH\MsJwtBundle\Entity\AbstractEntity
{
     ...
     * @var bool|null
     *
     * @ORM\Column(name="acompte_choice", type="boolean", nullable=true)
     */
    private $acompteChoice ;
     ...
     * @var Iban
     *
     * @ORM\ManyToOne(targetEntity="Iban"), fetch="EAGER"
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="iban_id", referencedColumnName="id")
     * })
     */
    private $iban;
     ...
     * @var Acompte
     *
     * @ORM\ManyToOne(targetEntity="Acompte"), fetch="EAGER"
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="acompte_id", referencedColumnName="id")
     * })
     */
    private $acompte;
  ...
  /*  public function getPostNote(): ?string
    ...
    public function getAcompteChoice(): ?bool
    {
        return $this->acompteChoice;
    }


    public function setAcompteChoice(?bool $acompteChoice): self
    {
        $this->acompteChoice = $acompteChoice;
        return $this;
    }
